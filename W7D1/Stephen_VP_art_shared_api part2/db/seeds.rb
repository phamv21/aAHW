...
comments = Comment.create([{user_id:users.first.id,artwork_id:steve_art1.id,body:'hey I love this'},{user_id:users.first.id,artwork_id:julia_art1.id,body:'hey I love this so much'},{user_id:users[1].id,artwork_id:steve_art1.id,body:'hey I love this so so much he he'},{user_id:users[1].id,artwork_id:julia_art1.id,body:'common my baby can make something better than this this'}])
