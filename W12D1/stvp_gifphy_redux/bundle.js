...
var fetchSearchGiphys = function fetchSearchGiphys(term) {
  return function (dispatch) {
    _util_api_util__WEBPACK_IMPORTED_MODULE_0__["fetchSearchGiphys"](term).then(function (giphys) {
...
var GiphysIndex = function GiphysIndex(_ref) {
  var giphys = _ref.giphys,
      term = _ref.term;
  var list = giphys.map(function (giphy, idx) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h1", null, "Result for ", term), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", null, list));
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return GiphySearch; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/react.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
...
function (_React$Component) {
  ...
  function GiphySearch(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(GiphySearch).call(this, props));
    _this.state = {
      term: '',
      submited: false
    };
  ...
  _createClass(GiphySearch, [{
    ...
    value: function render() {
      ...
      }, "Search"), this.state.submited ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_giphys_index__WEBPACK_IMPORTED_MODULE_1__["default"], {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    fetchSearchGiphys: function fetchSearchGiphys(term) {
      return dispatch(Object(_actions_giphy_actions__WEBPACK_IMPORTED_MODULE_2__["fetchSearchGiphys"])(term));
    }
  };
};
...
var configureStore = function configureStore() {
  ...
  var store = Object(redux__WEBPACK_IMPORTED_MODULE_0__["createStore"])(_reducers_root_reducer__WEBPACK_IMPORTED_MODULE_2__["default"], preloadedState, Object(redux__WEBPACK_IMPORTED_MODULE_0__["applyMiddleware"])(redux_thunk__WEBPACK_IMPORTED_MODULE_1__["default"]));
  return store;
};
...
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fetchSearchGiphys", function() { return fetchSearchGiphys; });
var GIPHY_API_KEY = 'UANzqbfC6WprdpeAnU0WqnuYcceKQT49';
var fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  return $.ajax({
    method: 'GET',
    url: "http://api.giphy.com/v1/gifs/search?api_key=".concat(GIPHY_API_KEY, "&q=").concat(searchTerm, "&limit=25&offset=0&rating=g&lang=en")
  });
}; // for testing
